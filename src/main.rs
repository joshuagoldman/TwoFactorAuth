...
use actix_web::{App, HttpServer, web::{self, Data}, http};
use authentication_web_api::{database::{connection, self}, auth::{self, cache::AppCache}};
...
async fn main() -> std::io::Result<()> {
    ...
    HttpServer::new(move || {
        ...
        let login_cache: AppCache<uuid::Uuid> = crate::auth::cache::Cache::new_app_cache(session_duration_str);
